...
function Timeline(cvs) {
    ...
    function OnResize() {
      ...
      self.toggle(false);
      self.lines[0].reset(canvas.offsetWidth / 2 - 15);//longueur de la ligne vertical 1
      self.lines[1].reset(canvas.offsetWidth / 2 + 15);//longueur de la ligne vertical 2
    ...
    function init() {
      ...
      try {
        ...
        self.lines[0] = new Line(
          ...
          "#3A1C71", //couleur de la ligne gauche
          self.options,
          mouse
        );
        self.lines[1] = new Line(
          0,
          canvas.offsetHeight - 100,
          "#FFAF7B", //couleur de la ligne droite
          self.options,
          mouse
        );
      } catch (e) {
